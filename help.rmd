...
This Shiny application is an interactive interface to parts of the R package **secr** ([Efford 2020](#references)). The current source code is available from https://GitHub.com/MurrayEfford/secrapp.
...
By default, input is from two text files, one for the detector layout and one for detections ('captures') of known individuals. Excel files may also be used. Alternatively, secrapp may  read the secr capthist object from a .rds file.
