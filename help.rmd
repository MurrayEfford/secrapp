...
By default, input is from two text files, one for the detector layout and one for detections ('captures') of known individuals. Excel files may also be used. Alternatively, secrapp may  read the complete secr capthist object from a .rds file.
...
* user-specified code, possibly referencing the capthist (`ch`) or fitted model (`fitted`)
